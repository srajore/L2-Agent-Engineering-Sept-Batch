# Session 8 Trainer Guide — Human in the Loop

## Outcome

By the end of the session, a learner can run one file and explain how it helps them pause for a simple human decision.
