# Session 9 Trainer Guide — RAG Engineering

## Outcome

By the end of the session, a learner can run one file and explain how it helps them retrieve one local fact before model generation.
