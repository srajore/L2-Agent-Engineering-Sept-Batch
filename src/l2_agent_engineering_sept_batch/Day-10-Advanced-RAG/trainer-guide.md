# Session 10 Trainer Guide — Advanced RAG

## Outcome

By the end of the session, a learner can run one file and explain how it helps them rewrite, score, and select local evidence.
